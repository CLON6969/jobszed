...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <iframe id="contentFrame" src="{{ route('user.Seller.profile-account.index') }}"></iframe>
    </div>
...
createNavButton('Dashboard', 'fa-solid fa-chart-line', 'Seller Dashboard', '{{ route("seller.dashboard") }}');
createNavButton('Products', 'fa-solid fa-box', 'My Products', '{{ route("seller.products.index") }}');
createNavButton('Variations', 'fa-solid fa-boxes-stacked', 'Product Variations', '{{ route("seller.variations.index") }}');
createNavButton('Media', 'fa-solid fa-image', 'Product Media', '{{ route("seller.media.index") }}');
