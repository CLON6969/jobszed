...
createNavButton('Dashboard','fas fa-tachometer-alt','Dashboard','{{ route("user.employer.dashboard.overview") }}');
createNavButton('Jobs', 'fas fa-briefcase', 'Jobs', '{{ route("user.employer.web.job.index") }}');
createNavButton('Applications', 'fas fa-file-alt', 'Applications', '{{ route('user.employer.web.applications.index') }}');
createNavButton('Applicant Email', 'fas fa-calendar-alt', 'Applicant Email', '{{ route("user.employer.web.Email_application_management.index", 1) }}');
createNavButton('My Profile','fa-solid fa-gears','My Profile','{{ route("user.employer.profile-account.index") }}');
