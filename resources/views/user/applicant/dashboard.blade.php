...
// Menu items with title
createNavButton('Dashboard','fas fa-tachometer-alt','Dashboard','{{ route("user.applicant.dashboard.overview") }}');
createNavButton('Personal', 'fa-solid fa-id-card','Personal', '{{ route("user.applicant.profiles.index") }}');
createNavButton('Certifications','fas fa-certificate','Certifications','{{ route("user.applicant.certifications.index") }}');
createNavButton('Educations','fas fa-graduation-cap','Educations','{{ route("user.applicant.educations.index") }}');
createNavButton('Experiences','fas fa-briefcase','Experiences','{{ route("user.applicant.experiences.index") }}');
createNavButton('Locations','fas fa-map-marker-alt','Locations','{{ route("user.applicant.locations.index") }}');
createNavButton('Voluntary Disclosures','fas fa-user-shield','Voluntary Disclosures','{{ route("user.applicant.voluntary_disclosures.edit") }}');
createNavButton('Jobs','fas fa-briefcase','Jobs','{{ route("user.applicant.jobs.index") }}');
createNavButton('My Profile','fa-solid fa-gears','My Profile','{{ route("user.applicant.profile-account.index") }}');
