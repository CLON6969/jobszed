...
<!-- WELCOME HEADER -->
<header class="bg-white dark:bg-gray-900 shadow py-6 pt-20">
    ...
    <option value="Western" @if(request('location')=='Western') selected @endif>Western</option>
            ...
            <button type="submit"
                ...
                <i class="fas fa-search mr-2"></i> Search
                    ...
                    <a href="{{ route('home.index') }}" class="text-white bg-gray-600 text-center py-3 font-semibold hover:underline rounded-lg shadow transition hover:bg-gray-700">Reset</a>
        </div>
