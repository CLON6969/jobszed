...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <iframe id="contentFrame" src="{{ route('Seller.profile-account.index') }}"></iframe>
    </div>
...
createNavButton('Analytics', 'fa-solid fa-chart-pie', 'Analytics', '{{ route("Seller.analytics.index") }}');
createNavButton('Products', 'fa-solid fa-box', 'My Products', '{{ route("Seller.products.index") }}');
createNavButton('Variations', 'fa-solid fa-boxes-stacked', 'Product Variations', '{{ route("Seller.product-variations.index") }}');
createNavButton('Media', 'fa-solid fa-image', 'Product Media', '{{ route("Seller.product-media.index") }}');
createNavButton('Orders', 'fa-solid fa-clipboard-list', 'Orders', '{{ route("Seller.orders.index") }}');
createNavButton('Messages', 'fa-solid fa-envelope', 'Messages', '{{ route("Seller.messages.index") }}');
createNavButton('Categories', 'fa-solid fa-list', 'Categories', '{{ route("Seller.categories.index") }}')
createNavButton('My Profile','fa-solid fa-gears','My Profile','{{ route("Seller.profile-account.index") }}');
