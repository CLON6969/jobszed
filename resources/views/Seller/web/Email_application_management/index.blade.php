            ...
            <div class="job-details d-none" id="job-{{ $job->id }}">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Shortlisted --}}
                        <form method="POST" action="{{ route('user.employer.web.Email_application_management.storeDetail', [$job->id, 'shortlisted']) }}">
                            @csrf
                            <h6>Shortlisted</h6>
                        ...
                        {{-- Rejected --}}
                        <form method="POST" action="{{ route('user.employer.web.Email_application_management.storeDetail', [$job->id, 'rejected']) }}">
                            @csrf
                            <h6>Rejected</h6>
                        ...
                        {{-- Interview --}}
                        <form method="POST" action="{{ route('user.employer.web.Email_application_management.storeDetail', [$job->id, 'interview']) }}">
                            @csrf
                            <h6>Interview</h6>
                            <div class="row g-2">
                                <div class="col-md-6">
                        ...
                        {{-- Accepted --}}
                        <form method="POST" action="{{ route('user.employer.web.Email_application_management.storeDetail', [$job->id, 'accepted']) }}">
                            @csrf
                            <h6>Accepted</h6>
                            <div class="row g-2">
                                <div class="col-md-6">
        ...
        <div class="col-md-8">
            ...
            <div class="template-details d-none" id="template-{{ $template->id }}">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.employer.web.Email_application_management.updateEmailTemplate', $template->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-2">
                                <label>Subject</label>
