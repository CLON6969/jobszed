        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <select name="delivery_available" class="w-full border-gray-300 rounded-lg shadow-sm p-3 @error('delivery_available') border-red-500 @enderror">
                    <option value="1" {{ old('delivery_available') == '1' ? 'selected' : '' }}>Yes</option>
                    <option value="0" {{ old('delivery_available') == '0' ? 'selected' : '' }}>No</option>
                </select>
        ...
        <div id="variation-section">
            <div class="variation-group mb-4 border rounded p-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <input type="text" name="variations[0][name]" placeholder="Variation Name" value="{{ old('variations.0.name') }}" class="border rounded p-2">
                    <input type="text" name="variations[0][option]" placeholder="Option" value="{{ old('variations.0.option') }}" class="border rounded p-2">
                    <input type="number" step="0.01" name="variations[0][price_adjustment]" placeholder="Price Adjustment" value="{{ old('variations.0.price_adjustment') }}" class="border rounded p-2">
                    <input type="number" name="variations[0][stock]" placeholder="Stock" value="{{ old('variations.0.stock') }}" class="border rounded p-2 variation-stock">
                </div>
            </div>
        </div>
