    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
            ...
            <div class="flex gap-3 mb-6">
                @auth
                    <form action="{{ route('Customer.home.save', $product->id) }}" method="POST">
                        @csrf
                        <button type="submit"
            ...
            {{-- Message Seller --}}
            <form id="myForm"  method="POST" action="{{ route('Customer.home.message', $product->id) }}" class="bg-gray-50 p-4 rounded-lg border" onsubmit="return handleWhatsApp(event)">
                @csrf
        ...
        <div class="mt-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                @foreach($relatedProducts as $related)
                    <a href="{{ route('Customer.home.show', $related->id) }}" class="block bg-white border rounded-lg overflow-hidden hover:shadow-md transition">
